...
public class TodosPage {
	...
	private By btn_delete= By.xpath("//*[@class='destroy']");
	...
	{
		return By.xpath("//ul[@class='todo-list']/li/div/label[text()='" + taskName+"']/preceding-sibling::input[@class='toggle']");
	}
	
	private By getTaskDeleteButton(String taskName)
	{
		return By.xpath("//ul[@class='todo-list']/li/div/label[text()='" + taskName+"']/following-sibling::input[@class='destroy']");
	}
